...
const RestaurantDetail = ({ onClose }) => {
  const navigate = useNavigate();
  
  const store = {
    name: "中8楼风尚云南菜(颐提港店)",
    openHours: "11:00-21:00",
    address: "朝阳区酒仙桥路颐提港三层L3-49",
    tags: ["儿童游乐区", "宝宝椅", "有露天位"],
    image: "https://nocode.meituan.com/photo/search?keyword=yunnan,cuisine,restaurant&width=400&height=300"
  };
  ...
  const packages = [
    {
      ...
      price: 28.9,
      originalPrice: 50,
      image: "https://nocode.meituan.com/photo/search?keyword=chicken,pot,yunnan&width=200&height=200"
    },
    {
      id: 2, 
      name: "野山菌跑山鸡双人分享餐",
    ...
    },
    {
      ...
      price: 89.9,
      originalPrice: 50,
      image: "https://nocode.meituan.com/photo/search?keyword=fish,yunnan&width=200&height=200"
    }
  ];
  ...
  return (
    <div className="w-full h-full overflow-hidden">
      ...
      {/* 导航区域 */}
      <div className="bg-white px-3" style={{ borderTop: 'none', marginTop: '-1px' }}>
        <img 
          src="/路线规划@2x.png" 
          alt="路线规划"
          className="w-full"
